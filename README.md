<img width="512" height="512" alt="logo (1)" src="https://github.com/user-attachments/assets/f5c08a81-6ab5-4af9-a01b-3c9ad8b8c9fc" />
<svg width="512" height="512" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <!-- Pure green gradient (no orange) -->
    <linearGradient id="green_grad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" stop-color="#0f5c4a" />   <!-- dark forest green -->
      <stop offset="50%" stop-color="#22ab94" />  <!-- teal -->
      <stop offset="100%" stop-color="#55d6b5" /> <!-- bright mint green -->
    </linearGradient>
  </defs>

  <!-- Y – only the two upper branches (no bottom leg) -->
  ...
  <!-- A – only the inverted V (no horizontal crossbar) -->
